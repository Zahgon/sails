  ...
  return {
    ...
    defaults: {
      ...
      http: {
        middleware: {
          ...
          // Built-in HTTP middleware functions are injected after the Fastify
        ...
        // Extra options to pass directly into the underlying HTTP(S) server
        ...
        // Custom middleware function to use (receives the Fastify app instance).
        ...
        // (this is used to compile the "trust proxy" setting for incoming requests)
        trustProxy: false,
    ...
    configure: function() {
      ...
      if (sails.config.http.customMiddleware) {
        ...
        sails.log.debug('Instead, use a connect-style middleware (req, res, next) function.');
